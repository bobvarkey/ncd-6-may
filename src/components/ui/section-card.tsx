  ...
  const ActionButtons = exportable ? (
    <div className="flex items-center gap-1.5">
      <button
        ...
        title={`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            make a mini app for cSDH; {\n\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n\n  \"$id\": \"https://example.org/schemas/csdh-perioperative-risk-miniapp.schema.json\",\n\n  \"title\": \"Chronic Subdural Hematoma Perioperative Risk Mini-App\",\n\n  \"description\": \"Clinical decision-support schema for structured assessment of chronic or acute-on-chronic subdural hematoma. This tool supports documentation, multidisciplinary risk communication, and shared decision-making. It does not determine indication for surgery and must not delay urgent neurosurgical intervention.\",\n\n  \"type\": \"object\",\n\n  \"required\": [\n\n    \"patient\",\n\n    \"assessment_context\",\n\n    \"neurological_assessment\",\n\n    \"ct_mass_effect_assessment\",\n\n    \"frailty_and_baseline_function\",\n\n    \"perioperative_assessment\",\n\n    \"clinical_summary\"\n\n  ]}`}
