...
export const GLP1_PRODUCTS: Glp1Product[] = [
  ...
  },
  {
    ...
    indication: "Type 2 diabetes",
    steps: [
      { dose: "3 mg", weeks: 4, label: "Starting dose" },
      { dose: "7 mg", weeks: 4, label: "Therapeutic dose" },
      { dose: "14 mg", weeks: 0, label: "Maximum dose" },
    ],
    sites: ["Oral — no injection. Take on waking with ≤120 mL water, wait 30 min before food/other drugs."],
    storage: "Room temperature in original blister; keep dry.",
    sideEffects: ["Nausea", "Diarrhoea", "Reduced appetite", "Abdominal pain"],
    cautions: ["Medullary thyroid carcinoma / MEN 2", "Pancreatitis history", "Absorption falls if taken with food"],
  },
];
