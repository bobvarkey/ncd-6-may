...
const TREATMENT_RECS: Record<string, { title: string; drug: string; rationale: string; followUp: string; alternative: string; mechanism: string; monitoring: string; targets: string[] }> = {
  "EHR-A": {
    ...
    alternative: "If statin-intolerant: Rosuvastatin 5-10 mg + Ezetimibe + Bempedoic acid 180 mg OD. For patients declining or unable to use injectable PCSK9i: Enlicitide (Lipfendra) 20 mg PO once daily on empty stomach — oral PCSK9i (FDA approved Jul 2026; see Lipfendra section below for citations). Consider Red Yeast Rice with monitoring if unwilling to take statins.",
